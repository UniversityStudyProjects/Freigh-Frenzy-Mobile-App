//
//  ScoreRecordsViewController.swift
//  Freight Frenzy App
//
...
class ScoreRecordsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "TeamId: " +  DataManager.shared.scores[indexPath.row].tid + "  Score: " + DataManager.shared.scores[indexPath.row].total
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "detailsSegue"{
            ...
            vc.score = DataManager.shared.scores[indexPath.row]
        }
